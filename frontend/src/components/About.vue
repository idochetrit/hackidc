...
<style scoped>
  .container-fluid {
    ...
    background: -webkit-linear-gradient(to top, #fff, #f7f7f7);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to top, #fff, #f7f7f7); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    padding: 4rem 0;
  }
  img {
    width: 100%;
