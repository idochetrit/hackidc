        ...
        <div class="row">
            <div class="box">
                ...
                <div class="form-group">
                    <input v-model="user.username" id="judges-username" placeholder="Username" class="form-control" type="text">
                </div>
                <div class="form-group">
                    <input v-model="user.password" id="judges-password" placeholder="Password" class="form-control" type="password">
                </div>
...
<script>
  export default {
    ...
    methods: {
      signin() {
        alert("judge login: " + this.user.username);
      }
    }
  }
</script>
